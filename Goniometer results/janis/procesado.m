        ...
        caderaT=load('prueba1janistenis_AngulosCadera.mat');
        rodillaT=load('prueba1janistenis_AngulosRodilla.mat');
        tobilloT=load('prueba1janistenis_AngulosTobillo.mat');
        tiempoT=load('prueba1janistenis_TiempoAngulos.mat');
        ...
        caderaT(1,pos)=-20;
                ...
                caderaT2=load('prueba2janistenis_AngulosCadera.mat');
                rodillaT2=load('prueba2janistenis_AngulosRodilla.mat');
                tobilloT2=load('prueba2janistenis_AngulosTobillo.mat');
                tiempoT2=load('prueba2janistenis_TiempoAngulos.mat');
...
caderaTa=load('prueba1janistacones_AngulosCadera.mat');
rodillaTa=load('prueba1janistacones_AngulosRodilla.mat');
tobilloTa=load('prueba1janistacones_AngulosTobillo.mat');
tiempoTa=load('prueba1janistacones_TiempoAngulos.mat');
...
caderaTa(1,pos)=-20;
        ...
        caderaTa2=load('prueba2janistacones_AngulosCadera.mat');
        rodillaTa2=load('prueba2janistacones_AngulosRodilla.mat');
        tobilloTa2=load('prueba2janistacones_AngulosTobillo.mat');
        tiempoTa2=load('prueba2janistacones_TiempoAngulos.mat');
...
% %         [val pos]=find(tobilloTa2<80);
% %         tobilloTa2(1,pos)=100;
