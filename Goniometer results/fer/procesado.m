...
%Procesado prueba 1 tenis
        caderaT=load('Prueba1fer_AngulosCadera.mat');
        rodillaT=load('Prueba1fer_AngulosRodilla.mat');
        tobilloT=load('Prueba1fer_AngulosTobillo.mat');
        tiempoT=load('Prueba1fer_TiempoAngulos.mat');
        ...
        caderaT(1,pos)=-20;
                ...
                caderaT2=load('Prueba2fer_AngulosCadera.mat');
                rodillaT2=load('Prueba2fer_AngulosRodilla.mat');
                tobilloT2=load('Prueba2fer_AngulosTobillo.mat');
                tiempoT2=load('Prueba2fer_TiempoAngulos.mat');
...
caderaTa=load('Prueba1fertacones_AngulosCadera.mat');
rodillaTa=load('Prueba1fertacones_AngulosRodilla.mat');
tobilloTa=load('Prueba1fertacones_AngulosTobillo.mat');
tiempoTa=load('Prueba1fertacones_TiempoAngulos.mat');
...
caderaTa(1,pos)=-20;
    ...
    caderaTa2=load('Prueba2fertacones_AngulosCadera.mat');
    rodillaTa2=load('Prueba2fertacones_AngulosRodilla.mat');
    tobilloTa2=load('Prueba2fertacones_AngulosTobillo.mat');
    tiempoTa2=load('Prueba2fertacones_TiempoAngulos.mat');
